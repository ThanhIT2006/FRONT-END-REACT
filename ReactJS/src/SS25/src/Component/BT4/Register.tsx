...
function Register() {
    ...
    return (
        <div style={{border: '1px solid black', padding:'30px',width:'400px'}}>
            ...
            <label style={{marginTop:'10px'}} htmlFor="">Confirm Password</label><br />
            <input style={{backgroundColor:'white', width:'100%', padding:'5px', borderRadius:"5px", opacity:"0.7"}} type="password" placeholder='********' /><br />
            <Button style={{width:'100%', marginTop:'10px'}} variant="primary">Create an account</Button><br />
            <p style={{textAlign:'center',marginTop:'20px', opacity:'0.7'}}>Already have an account? <b>Login here</b></p>
        </div>
    )
}
