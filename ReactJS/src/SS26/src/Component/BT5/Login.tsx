  ...
  return (
    <div>
      <form action="" onSubmit={handleSubmit} style={{textAlign: 'center'}}>
        <p>Đăng nhập</p>
        <input type="text" placeholder='Nhập email' onChange={handleEmail}/><br />
        <input type="password" placeholder='Nhập mật khẩu' onChange={handlePass}/><br />
        <select onChange={handleRoll} style={{width: '169px'}}>
          <option value="" hidden>--Chọn quyền--</option>
          <option value="Admin">Admin</option>
          <option value="User">User</option>
        </select><br />
        <button style={{marginTop: '10px', width: '169px'}}>Đăng nhập</button>
      </form>
    </div>
  )
}